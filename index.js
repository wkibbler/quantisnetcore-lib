...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of quantisnetcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of quantisnetcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._quantisnetcore);
global._quantisnetcore = bitcore.version;
...
bitcore.deps._ = require('loquantisnet');
