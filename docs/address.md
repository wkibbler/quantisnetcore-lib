# Quantsisnet Address
Represents a Quantsisnet address. Addresses are the most popular way to make Quantsisnet transactions. See [the Quantsisnet documentation](https://quantisnet-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/quantisnetevo/bitcore-quantisnet/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/quantisnetevo/bitcore-quantisnet/tree/master/lib/errors/spec.js).
