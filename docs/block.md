...
For detailed technical information about a block please visit [Blocks](https://quantisnet-docs.github.io/en/glossary/block) on the Quantsisnet Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://quantisnet-docs.github.io/en/developer-reference#block-headers) page on the Quantsisnet Developer Reference Wiki.
