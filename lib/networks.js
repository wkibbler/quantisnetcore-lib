...
addNetwork({
  ...
  privatekey: 0x6a,
  scripthash: 0x35,
  xpubkey: 0x03B8C856,    // 'xpub' (Bitcoin Default)
  xprivkey: 0xD7DC6E9F,   // 'xprv' (Bitcoin Default)
  networkMagic: 0xf9bcbad4,
  port: 9796,
  dnsSeeds: [
    'dnsseed.darkcoin.io',
    'dnsseed.quantisnetdot.io',
    'dnsseed.masternode.io',
    'dnsseed.quantisnetpay.io'
  ]
});
